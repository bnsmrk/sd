    ...
    <AppLayout>
        ...
        <div class="p-4">
            <div class="mb-4 flex flex-wrap items-center justify-between gap-3">
                <h1 class="text-xl font-bold text-pink-400">Users</h1>
                ...
                <table class="min-w-full table-auto text-left text-sm text-pink-400">
                    ...
                    <tbody class="divide-y divide-pink-100 bg-white">
                        <tr v-for="user in sortedUsers" :key="user.id" class="hover:bg-pink-50">
                            <td class="px-6 py-4 text-[#01006c]">{{ user.name }}</td>
                            ...
                            <td class="space-x-2 px-6 py-4 text-center">
                                ...
                                <button @click="confirmDelete(user.id)" class="text-red-600 hover:text-red-800">
