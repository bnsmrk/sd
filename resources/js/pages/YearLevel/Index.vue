        ...
        <div class="p-6">
            <div class="mb-4 flex items-center justify-between">
                ...
                <button @click="openAddModal"
                    ...
                    <Plus class="w-4 h-4" /> Add Year Level
                </button>
            </div>
                    ...
                    <tbody class="divide-y divide-gray-100 bg-white text-sm">
                        <tr v-for="level in yearLevels" :key="level.id">
                            ...
                            <td class="px-6 py-4 text-center space-x-2">
                                ...
                                <button @click="openDeleteModal(level.id)"
                ...
                <form @submit.prevent="createYearLevel" class="space-y-4">
                    ...
                    <div class="flex justify-end space-x-2">
                        <button type="button" @click="showAddModal = false"
                            class="inline-flex items-center gap-1 px-4 py-2 bg-gray-300 rounded">
                            <X class="w-4 h-4" /> Cancel
                        </button>
                        <button type="submit"
                            class="inline-flex items-center gap-1 px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700">
            ...
            <div class="w-full max-w-md rounded-lg bg-white p-6 shadow-lg">
                ...
                <form @submit.prevent="updateYearLevel" class="space-y-4">
                    ...
                    <div class="flex justify-end space-x-2">
                        ...
                        <button type="submit"
                            class="inline-flex items-center gap-1 px-4 py-2 bg-green-600 text-white rounded hover:bg-green-700">
                            <Check class="w-4 h-4" /> Update
                        </button>
                    </div>
                </form>
            </div>
        ...
        <div v-if="showDeleteModal" class="fixed inset-0 z-50 flex items-center justify-center bg-black/30 backdrop-blur-sm">
            <div class="w-full max-w-md rounded-lg bg-white p-6 shadow-lg">
                ...
                <div class="flex justify-end space-x-2">
                    ...
                    <button @click="deleteYearLevel"
                        class="inline-flex items-center gap-1 px-4 py-2 bg-red-600 text-white rounded hover:bg-red-700">
                        <Trash2 class="w-4 h-4" /> Delete
                    </button>
                </div>
            </div>
