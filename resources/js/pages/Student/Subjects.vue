...
<template>
    <AppLayout>
        <div class="space-y-4 p-6">
            ...
            <div v-if="selectedSubjectId" class="mt-8 rounded-xl border border-sidebar-border/70 p-4 dark:border-gray-700">
                ...
                <ul class="space-y-2">
                    <li
                        ...
                        :key="act.id"
                        class="cursor-pointer rounded-lg border p-3 hover:bg-gray-50 dark:hover:bg-gray-700"
