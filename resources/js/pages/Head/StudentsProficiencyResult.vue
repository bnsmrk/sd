    ...
    <div class="space-y-6 p-6">
      ...
      <div v-if="filtersApplied && props.individuals.length > 0" class="space-y-8">
        ...
        <div>
          ...
          <table class="w-full border-collapse overflow-hidden rounded-md shadow-sm text-sm">
        ...
        <!-- Year Level Average -->
        <div class="mt-2 text-lg font-bold text-[#01006c] flex items-center gap-2">
      ...
      <!-- No Results -->
      <div v-else-if="filtersApplied" class="mt-8 text-center text-sm italic text-gray-500">
