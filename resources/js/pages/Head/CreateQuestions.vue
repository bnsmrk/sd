    ...
    <AppLayout>
      <div class="p-8">
        ...
        <div class="mb-6">
          ...
          >
            <ArrowLeft class="w-4 h-4 text-[#01006c]" />
            Back to Tests
          </Link>
        </div>
        ...
        <div class="grid grid-cols-1 gap-6 md:grid-cols-3">
            ...
            <div class="space-y-4">
              ...
              <div>
                <label class="mb-1 flex items-center gap-2 font-semibold text-[#ff69b4]">
                  <FileText class="w-4 h-4 text-[#ff69b4]" /> Title
                </label>
                <input type="text" :value="props.proficiencyTest.title" disabled class="w-full rounded border-2 border-[#01006c] px-3 py-2 bg-white focus:outline-none focus:border-[#ffc60b]" />
              </div>
  
              <!-- Type -->
              <div>
                <label class="mb-1 flex items-center gap-2 font-semibold text-[#ff69b4]">
                  <ListChecks class="w-4 h-4 text-[#ff69b4]" /> Type
                </label>
                <input type="text" :value="props.proficiencyTest.type" disabled class="w-full rounded border-2 border-[#01006c] px-3 py-2 bg-white focus:outline-none focus:border-[#ffc60b]" />
              </div>
  
              <!-- Scheduled At -->
              <div>
                <label class="mb-1 flex items-center gap-2 font-semibold text-[#ff69b4]">
                  <CalendarClock class="w-4 h-4 text-[#ff69b4]" /> Scheduled At
                </label>
                <input type="text" :value="props.proficiencyTest.scheduled_at" disabled class="w-full rounded border-2 border-[#01006c] px-3 py-2 bg-white focus:outline-none focus:border-[#ffc60b]" />
              </div>
  
              <!-- Year Level -->
              <div>
                <label class="mb-1 flex items-center gap-2 font-semibold text-[#ff69b4]">
                  <BookOpen class="w-4 h-4 text-[#ff69b4]" /> Year Level
                </label>
                <input type="text" :value="props.proficiencyTest.year_level.name" disabled class="w-full rounded border-2 border-[#01006c] px-3 py-2 bg-white focus:outline-none focus:border-[#ffc60b]" />
              </div>
            </div>
          </div>
          ...
          <div class="col-span-1 md:col-span-2">
            ...
            <div
              ...
              :key="q.id ?? idx"
              class="mb-8 rounded-lg border border-[#01006c] bg-white p-6 shadow-md"
            >
              ...
              <div class="mb-4">
                ...
                <input v-model="q.question" type="text" class="w-full rounded border-2 border-[#01006c] px-3 py-2 focus:outline-none focus:border-[#ffc60b] bg-white" />
              </div>
  
              <!-- Type Dropdown -->
              <div class="mb-4">
                <label class="mb-1 block font-semibold text-[#ff69b4]">Type</label>
                <select v-model="q.type" @change="onTypeChange(idx)" class="w-full rounded border-2 border-[#01006c] px-3 py-2 focus:outline-none focus:border-[#ffc60b] bg-white">
              ...
              <template v-if="q.type === 'multiple_choice'">
                <div class="mb-4">
                  ...
                  <div v-for="(opt, i) in q.options" :key="i" class="mb-2 flex items-center gap-2">
                    ...
                    <input v-model="q.options[i]" class="w-full rounded border-2 border-[#01006c] px-3 py-2 bg-white focus:outline-none focus:border-[#ffc60b]" type="text" />
                    <button v-if="q.options.length > 2" type="button" @click="q.options.splice(i, 1)" class="text-red-600 hover:text-red-800">
              ...
              <template v-if="q.type === 'true_false'">
                ...
                <select v-model="q.answer_key" class="w-full rounded border-2 border-[#01006c] px-3 py-2 focus:outline-none focus:border-[#ffc60b] bg-white">
              ...
              <template v-if="q.type === 'essay' || q.type === 'fill_in_blank'">
                ...
                <input v-model="q.answer_key" class="w-full rounded border-2 border-[#01006c] px-3 py-2 bg-white focus:outline-none focus:border-[#ffc60b]" type="text" />
              </template>
  
              <button @click="removeQuestion(idx)" type="button" class="mt-3 text-sm text-red-600 inline-flex items-center gap-1 hover:text-red-800">
                <Trash2 class="w-4 h-4" />
                Remove Question
              </button>
            </div>
